...
# ----------------------------
# Load YOLOv8m from Hugging Face if missing
# ----------------------------
model_path = "yolov8m.pt"
hf_url = "https://huggingface.co/THE-NIKHIL07/yolov8m-model/resolve/main/yolov8m.pt"

if not os.path.exists(model_path):
    with st.spinner("Downloading YOLOv8m model (~52MB) from Hugging Face..."):
        os.system(f"curl -L -o {model_path} {hf_url}")
